...
class BranchOfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch_office" do
    assert_difference('BranchOffice.count') do
      post branch_offices_url, params: { branch_office: { desc_sucursal: @branch_office.desc_sucursal, dir_sucursal: @branch_office.dir_sucursal, id_ciudad: @branch_office.id_ciudad, id_sucursal: @branch_office.id_sucursal } }
    end
  ...
  test "should update branch_office" do
    patch branch_office_url(@branch_office), params: { branch_office: { desc_sucursal: @branch_office.desc_sucursal, dir_sucursal: @branch_office.dir_sucursal, id_ciudad: @branch_office.id_ciudad, id_sucursal: @branch_office.id_sucursal } }
