...
class CountriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create country" do
    assert_difference('Country.count') do
      post countries_url, params: { country: { id_pais: @country.id_pais, nombre_pais: @country.nombre_pais } }
    end
  ...
  test "should update country" do
    patch country_url(@country), params: { country: { id_pais: @country.id_pais, nombre_pais: @country.nombre_pais } }
