...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post departamentos_url, params: { departamento: { desc_departamento: @departamento.desc_departamento, id_departamento: @departamento.id_departamento, id_pais: @departamento.id_pais } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { desc_departamento: @departamento.desc_departamento, id_departamento: @departamento.id_departamento, id_pais: @departamento.id_pais } }
