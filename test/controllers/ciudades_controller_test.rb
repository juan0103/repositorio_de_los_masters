...
class CiudadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ciudade" do
    assert_difference('Ciudade.count') do
      post ciudades_url, params: { ciudade: { desc_ciudad: @ciudade.desc_ciudad, id_ciudad: @ciudade.id_ciudad, id_departamento: @ciudade.id_departamento } }
    end
  ...
  test "should update ciudade" do
    patch ciudade_url(@ciudade), params: { ciudade: { desc_ciudad: @ciudade.desc_ciudad, id_ciudad: @ciudade.id_ciudad, id_departamento: @ciudade.id_departamento } }
