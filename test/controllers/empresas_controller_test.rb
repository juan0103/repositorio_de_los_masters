...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { dir_empresa: @empresa.dir_empresa, id_empresa: @empresa.id_empresa, nombre_empresa: @empresa.nombre_empresa } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { dir_empresa: @empresa.dir_empresa, id_empresa: @empresa.id_empresa, nombre_empresa: @empresa.nombre_empresa } }
